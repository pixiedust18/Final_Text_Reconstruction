...
from model_inpainting.networks import Generator
from utils_inpainting.tools import get_config, random_bbox, mask_image, is_image_file, default_loader, normalize, get_model_list
import cv2
...
def inpaint(image, im_shape, mask, output='output.png', checkpoint_path='', flow = '', iter=0, seed = None):
